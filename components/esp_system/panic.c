...
// ======================= CUSTOM variables, macros, and functions for panic handling =======================
...
// tgxwdt_isr to be called in case of panic, or when WDT_ACTION is set to interrupt (not sure if this works?)
